    ...
    <div class="h-full flex flex-col justify-between bg-slate-50 px-6 py-8 overflow-y-auto">
        ...
        <div class="my-auto py-4">
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <label for="password_confirmation" class="text-xs font-semibold text-slate-700 block">Konfirmasi Password</label>
                    <div class="relative">
                        <span class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <div class="flex items-start">
                    ...
                    <label for="terms" class="ml-2 text-xs font-medium text-slate-600 select-none cursor-pointer leading-relaxed">
                        Saya menyetujui <a href="#" class="text-blue-600 font-bold hover:underline">Syarat & Ketentuan</a> serta <a href="#" class="text-blue-600 font-bold hover:underline">Kebijakan Privasi</a> perusahaan.
                    </label>
                </div>
        ...
        <div class="mt-auto pt-4 text-center">
            <p class="text-xs text-slate-500 font-medium">
                Sudah punya akun? 
                <a href="/login" class="text-blue-600 font-bold hover:text-blue-700 transition-colors">Masuk di sini</a>
            </p>
