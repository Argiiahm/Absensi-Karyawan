        ...
        <div class="my-auto py-8 space-y-6">
            ...
            <div class="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex gap-3">
                ...
                <p class="text-xs text-blue-700 leading-relaxed">
                    Masukkan alamat email Anda yang terdaftar. Kami akan mengirimkan tautan (link) untuk mengatur ulang
                    kata sandi Anda.
                </p>
            </div>
            ...
            <form action="#" method="POST" class="space-y-5">
                ...
                <div class="space-y-1.5">
                    <label for="email" class="text-xs font-semibold text-slate-700 block">Alamat Email
                        Terdaftar</label>
                    <div class="relative">
