<x-layout-attedance>
    ...
    <div class="bg-white min-h-screen flex flex-col">
        ...
        <div class="bg-blue-600 text-white px-5 py-4 flex items-center gap-3">
            <a href="/attedance/ishoma/index" class="p-1">
        ...
        <div class="p-5 flex-1 flex flex-col">
            ...
            <div class="bg-slate-50 border border-slate-100 rounded-xl p-3 mb-6 flex justify-between items-center text-xs font-semibold text-slate-700">
                <span class="flex items-center gap-1.5">
                    ...
                    <span id="map-office-name">Mencari Kantor...</span>
                </span>
            ...
            <div id="status-card" class="border border-slate-200 bg-slate-50 rounded-xl p-4 flex items-center justify-between mb-6 transition-all duration-300">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h4 id="status-card-title" class="font-bold text-sm text-slate-755">
                            Mencari Lokasi Anda
                        </h4>
            ...
            <div class="mt-auto space-y-3">
                ...
                <p class="text-xs text-center text-slate-500 flex items-center justify-center gap-1.5 font-medium">
                    ...
                    Pastikan GPS aktif dan akurat sebelum mengambil selfie
                </p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function getLocation() {
            ...
            btnContinue.className = "w-full py-3.5 rounded-xl font-bold text-white bg-slate-355 cursor-not-allowed flex items-center justify-center gap-2 shadow-md transition-all duration-350";
        ...
        function updateUIError(title, desc) {
            ...
            statusCardDesc.className = "text-xs mt-1 text-red-655 font-medium";
